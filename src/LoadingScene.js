/*
 * This Scene needs to request the data from the server,
 * and preload the scene we start in.  The preloading
 * of adjacent scenes can be done by the MarioBrosScene.js
 *
 * 
 *
 * * * * * * * * * * * * * * * * * * * */
